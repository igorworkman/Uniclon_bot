...
├── docs/
│   └── troubleshooting.md        # Руководство по ошибкам и решениям
├── .github/
│   └── workflows/
│       └── main.yml              # CI-проверка синтаксиса и тестов
```
...
- `modules/time_utils.sh` — нормализация временных аргументов ffmpeg и безопасная обработка значений `-ss`.
...
- **.github/workflows/main.yml** — автоматическая проверка синтаксиса Bash и Python.
- **docs/troubleshooting.md** — справочник по кодам ошибок FFmpeg и FSM.
### 🧠 core/
