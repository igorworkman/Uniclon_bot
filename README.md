...
Отправьте видеофайл в Telegram-бота с подписью (например, 10) — это количество копий.

## 🧾 Changelog

v1.7 (2025-11-01)

- Исправлены ошибки инициализации `clip_start()`
- Добавлен fallback при сбоях FFmpeg
- Улучшены пользовательские сообщения
- Внедрена CI-проверка синтаксиса
- Добавлена документация troubleshooting
