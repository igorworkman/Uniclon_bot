#!/bin/bash
# Модуль generate_copy.sh
# Генерация одной уникальной копии видео с учётом профиля, фильтров, EXIF и fallback
# (автоматически подключается из process_protective_v1.6.sh)
